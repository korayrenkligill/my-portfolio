...
const ShortInformationItem = ({ image, description }: ShortInformationProp) => {
  return (
    <span className="flex items-center justify-center relative bg-gray-100 p-3 rounded-full mt-2 group border-2 border-gray-100 hover:border-purple-200 transition-colors cursor-pointer">
